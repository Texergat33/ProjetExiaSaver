        ...
        case 0:
            ...
            for(int z = 0; z < 5; z++)
            {
                for(int k = 0; k < 3; k++)
                {
                    ...
                    imageTable[(23+i*6)+k][z] = caseValue;
                }
            }
            fclose(file);
            break;
